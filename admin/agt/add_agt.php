...
// Query untuk mendapatkan ID terakhir dari tabel
...
$kode = isset($datakode['id_anggota']) ? $datakode['id_anggota'] : "B000"; // Default jika tidak ada data

$urut = substr($kode, 1, 3); // Mengambil angka dari ID terakhir
$tambah = (int) $urut + 1;
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<select name="kelas" id="kelas" class="form-control" required>
								...
								<option>XII TKL 1</option>
								<option>XII TKL 2</option>
								<option>XII TL 1</option>
							</select>
						</div>
